...
#' @param nested the nested model (i.e., a model that differs only in additional order constraints). Note that the nestedness of models is \italic{not} checked internally
